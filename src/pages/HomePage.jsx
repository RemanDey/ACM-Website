...
const MinecraftHotbar = () => {
  ...
  return (
    <nav className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50">
      {/* HOTBAR */}
      <div
        className="relative flex gap-[2px] p-[6px]"
        style={{
      ...
      >
        {navItems.map((item, index) => (
          <button
            ...
            className="relative w-[40px] h-[40px] md:w-[48px] md:h-[48px]"
            style={{
          ...
          >
            ...
            {/* LABEL (OPTIONAL – Minecraft doesn't show text) */}
            {item.name && (
              <span
                className="absolute bottom-1 left-1/2 -translate-x-1/2 text-[7px] md:text-[8px]"
                style={{
                  color: "#ffffff",
